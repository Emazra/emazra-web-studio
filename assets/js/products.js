...
if (template.credentials && template.credentials.length > 0) {
    template.credentials.forEach(cred => {
        ...
        const mobileCard = createCredentialCard(cred);
        
        credentialsContainer.appendChild(card);
        mobileCredentialsContainer.appendChild(mobileCard);
    });
} else {
...
// Update the credential card creation to use proper event handling
function createCredentialCard(cred) {
    ...
    card.innerHTML = `
        ...
        <div class="credential-field">
            ...
            <div class="credential-value">
                ...
                <button class="copy-btn" data-value="${cred.username}" type="button">
        ...
        <div class="credential-field">
            ...
            <div class="credential-value">
                ...
                <button class="copy-btn" data-value="${cred.password}" type="button">
                    <i class="fas fa-copy"></i>
                </button>
            </div>
        </div>
    ...
    // Add copy event listeners to the buttons in this card
    ...
    copyButtons.forEach(btn => {
        btn.addEventListener('click', async function(e) {
            ...
            if (success) {
                ...
                this.style.color = '#28a745'; // Green color for success
                ...
                this.style.color = '#dc3545'; // Red color for error
